...
if (isset($_POST['submit'])){
    ...
    $status= $_POST['status'];
    $sql = "INSERT INTO `feed` (`name`, `phone`,`police`,`experience`,`time`,`behaviour`,`dt`,`status`) VALUES ('$name', '$phone','$police','$experience','$time','$behaviour',current_timestamp(),'$status')";
...
<head>
  ...
  <link href="assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
    ...
    <title>Feedback Form for Citizens</title>
</head>
<body>
<!-- ======= Header ======= -->
  ...
  <div class="heading"><h1>Feedback Form For Citizen</h1></div>
    ...
    <form action="/Police Connect/form.php" method="post">
    <div class=" mx-3">
        ...
        <div class=" mx-3">
          ...
          <div class="mx-3">
            <input type="hidden" class="form-control" name="status" value="pending" aria-describedby="name">
          </div>
